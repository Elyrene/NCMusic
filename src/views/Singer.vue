...
const formateDuration = (ms: number) => {
    if (!ms) return '00:00';
...
<template>
    <div class="singer-page">
        <div class="singer-inner">
            <h2 class="title">"{{ tracks[0]?.artist }}" 的热门 50 首歌</h2>
            <div v-if="isLoading" class="tip">歌曲正在加载中...</div>
            ...
            <ul v-else class="track-list">
                ...
                >
                    ...
                    <div class="track-extra">
                        ...
                        <span class="track-duration">{{ formateDuration(track.durationMs) }}</span>
                    </div>
                </li>
            </ul>
        </div>
